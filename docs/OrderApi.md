...
<a id="orderCount"></a>
# **orderCount**
> OrderCount200Response orderCount(customerId, customerEmail, orderStatus, orderStatusIds, createdTo, createdFrom, modifiedTo, modifiedFrom, storeId, ids, orderIds, ebayOrderStatus, financialStatus, financialStatusIds, fulfillmentChannel, fulfillmentStatus, shippingMethod, deliveryMethod, tags, shipNodeType)
...
<a id="orderInfo"></a>
# **orderInfo**
> OrderInfo200Response orderInfo(orderId, id, params, responseFields, exclude, storeId, enableCache, useLatestApiVersion)
...
# **orderShipmentInfo**
> OrderShipmentInfo200Response orderShipmentInfo(id, orderId, start, params, responseFields, exclude, storeId)
...
<a id="orderUpdate"></a>
# **orderUpdate**
> AccountConfigUpdate200Response orderUpdate(orderId, storeId, orderStatus, cancellationReason, comment, adminComment, adminPrivateComment, dateModified, dateFinished, financialStatus, fulfillmentStatus, orderPaymentMethod, sendNotifications, origin, createInvoice, invoiceAdminComment)
