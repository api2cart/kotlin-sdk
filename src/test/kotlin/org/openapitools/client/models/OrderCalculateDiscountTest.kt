...
import org.openapitools.client.models.OrderCalculateDiscount

class OrderCalculateDiscountTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of OrderCalculateDiscount
        //val modelInstance = OrderCalculateDiscount()
        ...
        // to test the property `freeShipping`
        should("test freeShipping") {
            // uncomment below to test the property
            //modelInstance.freeShipping shouldBe ("TODO")
        }
