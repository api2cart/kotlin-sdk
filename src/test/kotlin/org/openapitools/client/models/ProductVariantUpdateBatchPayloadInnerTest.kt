...
class ProductVariantUpdateBatchPayloadInnerTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ProductVariantUpdateBatchPayloadInner
        //val modelInstance = ProductVariantUpdateBatchPayloadInner()
        ...
        // to test the property `retailPrice`
        ...
        // to test the property `categoriesIds` - If an empty array is passed, all entries will be deleted when the 'nested_items_update_behaviour' parameter is set to 'replace'.
        ...
        // to test the property `images` - The passed items will completely replace the original items
        should("test images") {
            // uncomment below to test the property
