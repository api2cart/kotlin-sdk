...
class ProductAddBatchPayloadInnerImagesInnerTest : ShouldSpec() {
    init {
        // uncomment below to create an instance of ProductAddBatchPayloadInnerImagesInner
        //val modelInstance = ProductAddBatchPayloadInnerImagesInner()
