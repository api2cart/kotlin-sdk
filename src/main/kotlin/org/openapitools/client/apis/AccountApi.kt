...
class AccountApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
     ...
     * @param shopeePartnerId Shopee Partner ID (optional)
     * @param shopeePartnerKey Shopee Partner Key (optional)
     * @param shopeeShopId Shopee SHOP ID (optional)
     * @param shopeeRefreshToken Shopee Refresh Token (optional)
     * @param shopeeRegion Shopee API endpoint Region. Use for Chinese Mainland or Brazil. (optional)
     * @param shopeeEnvironment Shopee Environment (optional)
     ...
     * @param unasApiKey UNAS API Key (optional)
     * @param shopwareApiKey Shopware api key (optional)
     * @param shopwareApiSecret Shopware client secret access key (optional)
     * @param bigcartelUserName Subdomain of store (optional)
     * @param bigcartelPassword BigCartel account password (optional)
     * @param bricklinkConsumerKey Bricklink Consumer Key (optional)
     * @param bricklinkConsumerSecret Bricklink Consumer Secret (optional)
     * @param bricklinkToken Bricklink Access Token (optional)
     * @param bricklinkTokenSecret Bricklink Access Token Secret (optional)
     ...
     * @param temuAppKey Temu App Key (optional)
     * @param temuAppSecret Temu App Secret (optional)
     * @param temuAccessToken Temu Access Token (optional)
     * @param temuRegion Temu API endpoint Region. (optional)
        ...
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                ...
                if (shopeePartnerId != null) {
                    put("shopee_partner_id", listOf(shopeePartnerId.toString()))
                }
                if (shopeePartnerKey != null) {
                    put("shopee_partner_key", listOf(shopeePartnerKey.toString()))
                }
                if (shopeeShopId != null) {
                    put("shopee_shop_id", listOf(shopeeShopId.toString()))
                }
                if (shopeeRefreshToken != null) {
                    put("shopee_refresh_token", listOf(shopeeRefreshToken.toString()))
                }
                if (shopeeRegion != null) {
                    put("shopee_region", listOf(shopeeRegion.toString()))
                }
                if (shopeeEnvironment != null) {
                    put("shopee_environment", listOf(shopeeEnvironment.toString()))
                }
                ...
                if (unasApiKey != null) {
                    put("unas_api_key", listOf(unasApiKey.toString()))
                }
                ...
                if (bigcartelUserName != null) {
                    put("bigcartel_user_name", listOf(bigcartelUserName.toString()))
                }
                if (bigcartelPassword != null) {
                    put("bigcartel_password", listOf(bigcartelPassword.toString()))
                }
                if (bricklinkConsumerKey != null) {
                    put("bricklink_consumer_key", listOf(bricklinkConsumerKey.toString()))
                }
                if (bricklinkConsumerSecret != null) {
                    put("bricklink_consumer_secret", listOf(bricklinkConsumerSecret.toString()))
                }
                if (bricklinkToken != null) {
                    put("bricklink_token", listOf(bricklinkToken.toString()))
                }
                if (bricklinkTokenSecret != null) {
                    put("bricklink_token_secret", listOf(bricklinkTokenSecret.toString()))
                }
                ...
                if (temuAppKey != null) {
                    put("temu_app_key", listOf(temuAppKey.toString()))
                }
                if (temuAppSecret != null) {
                    put("temu_app_secret", listOf(temuAppSecret.toString()))
                }
                if (temuAccessToken != null) {
                    put("temu_access_token", listOf(temuAccessToken.toString()))
                }
                if (temuRegion != null) {
                    put("temu_region", listOf(temuRegion.toString()))
                }
            }
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
        localVariableHeaders["Accept"] = "application/json"
