...
class AccountApi(basePath: kotlin.String = defaultBasePath, client: Call.Factory = ApiClient.defaultClient) : ApiClient(basePath, client) {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun accountCartList(params: kotlin.String? = "force_all", exclude: kotlin.String? = null, requestFromDate: kotlin.String? = null, requestToDate: kotlin.String? = null, storeUrl: kotlin.String? = null, storeKey: kotlin.String? = null) : AccountCartList200Response {
        val localVarResponse = accountCartListWithHttpInfo(params = params, exclude = exclude, requestFromDate = requestFromDate, requestToDate = requestToDate, storeUrl = storeUrl, storeKey = storeKey)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun accountCartListWithHttpInfo(params: kotlin.String?, exclude: kotlin.String?, requestFromDate: kotlin.String?, requestToDate: kotlin.String?, storeUrl: kotlin.String?, storeKey: kotlin.String?) : ApiResponse<AccountCartList200Response?> {
        val localVariableConfig = accountCartListRequestConfig(params = params, exclude = exclude, requestFromDate = requestFromDate, requestToDate = requestToDate, storeUrl = storeUrl, storeKey = storeKey)
     ...
     * @return RequestConfig
     */
    fun accountCartListRequestConfig(params: kotlin.String?, exclude: kotlin.String?, requestFromDate: kotlin.String?, requestToDate: kotlin.String?, storeUrl: kotlin.String?, storeKey: kotlin.String?) : RequestConfig<Unit> {
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class, UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun accountFailedWebhooks(count: kotlin.Int? = 10, start: kotlin.Int? = 0, ids: kotlin.String? = null) : AccountFailedWebhooks200Response {
        val localVarResponse = accountFailedWebhooksWithHttpInfo(count = count, start = start, ids = ids)
    ...
    @Suppress("UNCHECKED_CAST")
    @Throws(IllegalStateException::class, IOException::class)
    fun accountFailedWebhooksWithHttpInfo(count: kotlin.Int?, start: kotlin.Int?, ids: kotlin.String?) : ApiResponse<AccountFailedWebhooks200Response?> {
        val localVariableConfig = accountFailedWebhooksRequestConfig(count = count, start = start, ids = ids)
     ...
     * @return RequestConfig
     */
    fun accountFailedWebhooksRequestConfig(count: kotlin.Int?, start: kotlin.Int?, ids: kotlin.String?) : RequestConfig<Unit> {
        val localVariableBody = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, kotlin.collections.List<kotlin.String>>()
            .apply {
                if (count != null) {
